...
//     public ResponseEntity<Object> getWaitingWishlist(@Valid @PathVariable("coordinatorUserId") UUID coordinatorUserId){
//         try{
//             ArrayList<CourseWishlist> wishlists = coordinatorWishlistService.getWaitingWishlist(coordinatorUserId);
...
//         try{
//             Optional<CourseWishlist> wishedCourses = coordinatorWishlistService.getWishlist(coordinatorUserId, studentBilkentId);
...
//     public ResponseEntity<Object> determineWishlistStatus(@Valid @PathVariable("coordinatorUserId") UUID coordinatorUserId, @Valid @PathVariable("studentBilkentId") Long studentBilkentId, @Valid @PathVariable("status") boolean status){
//         try{
//             boolean isSuccessful = coordinatorWishlistService.determineWishlistStatus(coordinatorUserId, studentBilkentId, status);
//             return Response.create("Wishlist status of students is changed!", HttpStatus.OK, isSuccessful);
//         }catch(Exception e){
